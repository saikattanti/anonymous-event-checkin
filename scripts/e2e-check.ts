/**
 * End-to-end smoke check for anonymous-event-checkin.
 *
...
import { resolveNetwork, getOrCreateSeed, getDeployment } from '../checkin-cli/src/network';
import { createWallet, persistWalletState } from '../checkin-cli/src/wallet';
