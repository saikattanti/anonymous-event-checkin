...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      checkIn: (...args_1) => {
        ...
        const inviteSecret_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('checkIn',
                                     'argument 1 (as invoked from Typescript)',
                                     'event-checkin.compact line 31 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(inviteSecret_0),
    ...
    this.impureCircuits = { checkIn: this.circuits.checkIn };
    this.provableCircuits = { checkIn: this.circuits.checkIn };
  }
  initialState(...args_0) {
    if (args_0.length !== 2) {
  ...
  _checkIn_0(context, partialProofData, inviteSecret_0) {
    const _privateSecret_0 = inviteSecret_0;
    const tmp_0 = 1n;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
